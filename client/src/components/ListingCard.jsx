    ...
    return (
        ...
        hover:shadow-md transition'>
          ...
          {listing.featured && (
            <>
            <p className='py-1'></p>
  <div className='absolute top-0 left-0 w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white text-xs font-semibold text-center py-1 tracking-wide uppercase'>
    FEATURED</div>
  </>
)}
          <div className='p-5 pt-8'>
            ...
            <div className='flex items-center gap-3 mb-3'>
                ...
                <div className='flex flex-col'>
                    <h2>{listing.title}</h2>
                    <p>@{listing.username} - <span className='capitalize'>{listing.platform}
                    </span></p>
                </div>
