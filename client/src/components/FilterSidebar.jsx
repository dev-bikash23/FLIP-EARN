    ...
    max-sm:inset-0 z-100 max-sm:h-screen max-sm:overflow-scroll
     bg-white rounded-lg shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-[300px]`}>
        ...
        <div className='p-4 border-b border-gray-200'>
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <button onClick={() => setShowFilterPhone(false)} className='sm:hidden text-sm border text-gray-700 
                    px-3 py-1 rounded'>Apply</button>
                </div>
            </div>
        ...
        no-scrollbar'>
          ...
          {/* Search Bar */}
          <div className='flex items-center justify-between'>
            <input type="type" placeholder="Search by username, platform, niche, etc." 
          ...
          {/* Platform Filter */}
          <div>
            <button onClick={() => toggleSection("platform")} className='flex
          ...
          {/* Followers Range */}
          <div>
            <button onClick={() => toggleSection("followers")} className='flex 
            items-center justify-between w-full mb-3'>
            ...
            {expandedSections.followers && (
               ...
               onChange={(e)=>onFiltersChange({...filters, minFollowers: parseInt
                (e.target.value) || 0})}
